                    ...
                    <div class="col-md-12">
                        <div class="card" style="border:1px solid black;">
                            <div class="header" style="background-color:#66a6ff; height:60px;">
                                <h4  style="margin-top:0px; font-xeight:20px;" >Your Blood Pressure Levels</h4>
                                </div>
...
$query = "SELECT date, rate, AES_DECRYPT(rate)FROM  blood"; //You don't need a ; like you do in SQL
