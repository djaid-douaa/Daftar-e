                    ...
                    <div class="col-md-12">
                        <div class="card" style="border:1px solid black;">
                            <div class="header" style="background-color:#66a6ff; height:60px;">
                                <h4  style="margin-top:0px; font-xeight:20px;" >Your Blood Sugar Levels</h4>
                                </div>
                                <table class="table table-hover" >
                                    ...
                                    <tbody>							
										<tr>
                                        <form action="../includes/insert-medical-record.php?csrf=$_SESSION['csrf_token']" method="post" style=" border-radius : 3px">
											
											<td><input type="text" class="form-control" name="date" placeholder="Date"></td>
											<td><textarea id="note" class="form-control" name="rate" placeholder="Rate"></textarea></td>
											
											<td><button type="submit" class="btn btn-primary" style="border:2px solid #458ff6;">Save</button></td>
											<!-- CSRF Protection -->
     ...
     <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="border:1px solid black;">
                            <div class="header" style="background-color:#66a6ff; height:60px;">
                                <h4 style="margin-top:0px; font-xeight:20px;">History</h4>
...
$query = "SELECT date, rate, AES_DECRYPT(rate, $SECRET) FROM pressure"; //You don't need a ; like you do in SQL
$result = mysqli_query($connection, $query);					
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
										echo "<tbody>";
										echo "<tr>";
                                        echo "<td>" . XSSdisarm($row['blood_date']) . "</td>";
										echo "<td>" . XSSdisarm($row["AES_DECRYPT(blood_rate, $SECRET)"]) . "</td>";                                       
										echo "</tr>";
										echo "</tbody>";
										}
    ...
    <div class="footer">
		 <div class="container footer-container">
			<div class="footer-left">
				<a class="footer-logo__link" href="index.html"><img class="footer-logo" src="./img/logo.png" alt="White logo" width="159" height="41" style=" margin-left: 2px; "></a>
			...
			<div class="footer-col">
				...
				<ul class="footer-col__list">
					...
					<li class="footer-col__list-item"><a class="footer-col__list-link" href="services.php">services</a></li>
					<li class="footer-col__list-item"><a class="footer-col__list-link" href="register.php">Register</a></li>
				</ul>
			</div>
        ...
        <!-- <?php else : ?>
            ...
            <p>
                <span class="error">You are not authorized to access this page.</span> Please <a href="./index.html">login</a>.
            </p>
        <?php endif; ?> -->
